...
function globalVariables(){ 
  var varArray = {
    spreadsheetId   : '1c4S1dXfvWR7rlPYF6NGnE6xo_J6cYQZmQTMfzRXOZkg', //** CHANGE !!!
    dataRage        : 'หจฟว-ห!A2:G',                                    //** CHANGE !!!
    idRange         : 'หจฟว-ห!A2:A',                                    //** CHANGE !!!
    lastCol         : 'G',                                            //** CHANGE !!!
    insertRange     : 'หจฟว-ห!A1:G1',                                   //** CHANGE !!!
...
function getRangeByID(id){
  if(id){
    ...
    for(var i=0;i<idList.length;i++){
      if(id==idList[i][0]){
        return 'หจฟว-ห!A'+(i+2)+':'+globalVariables().lastCol+(i+2);
      }
    }
  }
}
...
function getLastTenRows(){
  ...
  if(lastRow<=11){
    ...
    var range = 'หจฟว-ห!A'+(lastRow-9)+':'+globalVariables().lastCol;
  }
